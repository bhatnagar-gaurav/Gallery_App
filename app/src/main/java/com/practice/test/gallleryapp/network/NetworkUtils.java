package com.practice.test.gallleryapp.network;
...
public class NetworkUtils {
     ...
     * @throws Exception
     *************************************************************************/
    public static String post(final String url, final List<NameValuePair> headers,
                              String body) throws Exception {
        String encodedBody = new String(body == null ? "".getBytes()
                : body.getBytes(), "UTF-8");
        // headers.add(new BasicNameValuePair("Content-Length", "" +
        // encodedBody.length()));
        HttpPost request = formPostWithCustomHeader(url, headers);
        request.setEntity(new StringEntity(null == encodedBody ? "" : encodedBody));
        return (null == request ? EMPTY_STRING : executeRequest(request));
    }

    /**********************************************************************/
    /**
     * Executes HTTP POST with parameters.
     *
     * @param url
     *            Destination URL.
     * @return response string.
    ...
    public static String post(final String url, final List<NameValuePair> params)
            throws IOException {
        HttpPost request = formPostRequest(url, params);
        return (null == request ? EMPTY_STRING : executeRequest(request));
    }

    /**********************************************************************/
    /**
     * Executes HTTP POST with custom header.
     *
     * @param url
     *            Destination URL.
     * @param header
     ...
     * @throws IOException
     *************************************************************************/
    public static String post(final String url, final List<NameValuePair> header,
                              final List<NameValuePair> params) throws IOException {
        HttpRequestBase request = formPostWithCustomHeader(url, header,
                params);
        return (null == request ? EMPTY_STRING : executeRequest(request));
    }
    ...
    /**********************************************************************/
    /**
     * Executes HTTP PUT with custom header.
     *
     * @param url
     *            Destination URL.
     * @param header
     ...
     * @throws IOException
     *************************************************************************/
    public static String put(final String url, final List<NameValuePair> header,
                             final List<NameValuePair> params) throws IOException {
        HttpRequestBase request = formPutRequest(url, header, params);
        return (null == request ? EMPTY_STRING : executeRequest(request));
    }
     ...
     * @throws IOException
     *************************************************************************/
    public static String put(final String url, final List<NameValuePair> headers,
                             String body) throws IOException {
        byte[] encodedBodyData  = Base64.decode(body.getBytes(), Base64.DEFAULT);
        HttpPut request = formPutRequest(url, headers,null);
        ByteArrayEntity encodedBodyDataEntity =  new ByteArrayEntity(encodedBodyData);
        request.setEntity(encodedBodyDataEntity);
    ...
    /**********************************************************************/
    /**
     * Executes HTTP DELETE with custom header.
     *
     * @param url
     *            Destination URL.
     * @param header
     ...
     * @throws IOException
     *************************************************************************/
    public static String delete(final String url, final List<NameValuePair> header) throws IOException {
        HttpDelete request = formDeleteRequest(url, header);
        return (null == request ? EMPTY_STRING : executeRequest(request));
    }
    ...
    private static byte[] executeRequestData(final HttpRequestBase request)
        ...
        if (!isNetworkAvailable()) {
            throw new IOExceptionWithContent(
                    GalleryApplication.getInstance().getString(
    ...
    public static boolean isNetworkAvailable() {
        return ((ConnectivityManager) GalleryApplication.getInstance()
